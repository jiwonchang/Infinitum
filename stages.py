...
s1_wave10 = [('dialogue', 'smugglerLieut')]
stage1 = [s1_wave00, s1_wave01, s1_wave02, s1_wave03, s1_wave04, s1_wave05, s1_wave06, s1_wave07, 'empty wave', s1_wave08, s1_wave04]
...
stage2 = [s2_wave9, s2_wave8, s2_wave7, s2_wave3, s2_wave1, s2_wave2, s2_wave0, s2_wave4, s2_wave5]
...
d_stage1 = [["That's about far enough. I am one of Victor's Lieutenants, punk."], ["Who the hell do you think you are? I suggest you get lost. Now."],
            ["I'm Lieutenant Aethan of the Intergalactic Republic Army.", "Surrender now and give up Victor's location, and I will spare your life."],
            ["Ha! There's no chance in hell I'll betray the boss. At any rate,", "you're going to pay for killing my men!"]]
